# Generated by Django 2.2.16 on 2022-08-20 00:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rating_val', models.DecimalField(blank=True, decimal_places=2, default=None, max_digits=4, null=True, verbose_name='Рейтинг')),
                ...
                ('genre', models.ManyToManyField(blank=True, db_index=True, null=True, related_name='titles', to='reviews.Genre', verbose_name='Жанр')),
            ],
            options={
